...
export default function Medicines() {
    ...
    switch (activeTab) {
      case 'today':
        return medicineList.filter((med) => {
          const medDate = new Date(med.created_at).toDateString()
          return medDate === today && med.status === 'pending'
        })
      case 'upcoming':
  ...
  const todayMedicines = medicineList.filter((med) => {
    const medDate = new Date(med.created_at).toDateString()
    return medDate === new Date().toDateString()
  })
